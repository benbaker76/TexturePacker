                                ...
                                for (int i = 0; i < this.objTargaHeader.ColorMapLength; i++)
                                {
                                    ...
                                    switch (this.objTargaHeader.ColorMapEntrySize)
                                    {
                                        ...
                                        case 16:
                                            ...
                                            break;
                                        case 24:
                                            b = System.Convert.ToInt32(binReader.ReadByte());
                                            g = System.Convert.ToInt32(binReader.ReadByte());
                                            r = System.Convert.ToInt32(binReader.ReadByte());
                                            this.objTargaHeader.ColorMap.Add(System.Drawing.Color.FromArgb(r, g, b));
                                            break;
                                        case 32:
                                            a = System.Convert.ToInt32(binReader.ReadByte());
                                            b = System.Convert.ToInt32(binReader.ReadByte());
                                            g = System.Convert.ToInt32(binReader.ReadByte());
                                            r = System.Convert.ToInt32(binReader.ReadByte());
